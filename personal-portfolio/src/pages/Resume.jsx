...
const Resume = () => {
  return (
    ...
    <div className='my-40 flex flex-col justify-center items-center text-center gap-20'>
      ...
      <a href="https://drive.google.com/file/d/10hOIHiLYZatl_XtNyqHVr3AfxhFT6Sju/view?usp=sharing" style={{color:'#1e293b', fontFamily:'Poppins', fontSize:20, fontWeight: 'bold'}}>Click Me to Access Full Resume</a>
    </div>
