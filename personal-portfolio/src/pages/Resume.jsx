...
const Resume = () => {
  return (
    ...
    <div className='my-40 flex flex-col justify-center items-center text-center gap-20'>
      ...
      <a href="https://drive.google.com/file/d/1Ydo_1zkqeS5aSB-rfuxjbMRqkT3JGvGU/view?usp=sharing" style={{color:'white', fontFamily:'Consolas', fontSize:20, fontWeight: 'bold'}}>Click Me to Access Full Resume</a>
    </div>
